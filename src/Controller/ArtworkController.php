...
class ArtworkController extends AbstractController
{
    ...
    #[Route('/{id}/publish', name: 'app_artwork_publish', methods: ['POST'])]
    public function publish(Request $request, Artwork $artwork, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('publish'.$artwork->getId(), $request->request->get('_token'))) {
